...
public class SnapshotMetrics {
  ...
  public final Timer loadDomainMetadataTimer = new Timer();
  ...
  public SnapshotMetricsResult captureSnapshotMetricsResult() {
    return new SnapshotMetricsResult() {
      ...
      final long loadDomainMetadataDurationResult = loadDomainMetadataTimer.totalDurationNs();
      ...
      @Override
      public long getLoadDomainMetadataDurationNs() {
        return loadDomainMetadataDurationResult;
      }
    };
  }
  ...
  public String toString() {
    return String.format(
        "SnapshotMetrics(timestampToVersionResolutionTimer=%s, "
            ...
            + "loadDomainMetadataTimer=%s)",
        timestampToVersionResolutionTimer, loadInitialDeltaActionsTimer, loadDomainMetadataTimer);
  }
}
